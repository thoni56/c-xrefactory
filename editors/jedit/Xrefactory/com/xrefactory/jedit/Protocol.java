...
public static final String PPC_REFACTORING_PASTE_BLOCK = "paste-block";
...
public static final int PPC_AVR_REDUCE_NAMES = 260;
public static final int PPC_AVR_EXPAND_NAMES = 270;
