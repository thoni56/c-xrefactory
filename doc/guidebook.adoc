...
=== c-xrefactory.el== Data Structures
...
There where a multitude of specialized memory allocation functions. In
principle there where to types, static and dynamic. The dynamic could
