...
* Week 1: Extend structure and create full API
* Week 2: Refactor `collate()` and helper functions
* Week 3: Testing, cleanup, and documentation
...
1. **Parsing Context Stack** (1 week)
...
*Alternative Approach*: Add user dialog to explicitly mark extraction as expression-based rather than auto-detecting, which would reduce implementation time to 2-3 weeks but provide less seamless UX.
...
*Estimated Effort*: 4-5 weeks for full automatic detection, or 2-3 weeks for dialog-based approach
