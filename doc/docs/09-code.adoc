...
NOTE: The architectural direction for `cxfile.c` is documented in link:17-major-codebase-improvements.adoc[Chapter 17: Incremental cxfile.c Cleanup]. The high-level "Memory as Truth" vision is in link:15-roadmap.adoc[Chapter 15: Roadmap].
