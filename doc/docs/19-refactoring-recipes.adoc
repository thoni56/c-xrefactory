...
For detailed discussions of refactoring feature architecture and implementation phases, see link:11-planned-features.adoc[Chapter 11: Planned Features].
...
**Status**: Phase 1 complete. See link:11-planned-features.adoc[Planned Features: Move Function Between Files] for detailed design, what works now, and next steps.
