...
For detailed discussions of refactoring feature architecture and implementation phases, see link:16-planned-features.adoc[Chapter 16: Planned Features].
...
**Status**: Phase 1 complete. See link:16-planned-features.adoc[Planned Features: Move Function Between Files] for detailed design, what works now, and next steps.

**Purpose:** Move a function definition from one C source file to another while automatically managing visibility (static vs extern) and adding necessary declarations and includes.
...
Tentative. Change the return type across all declarations and definitions in one operation.
