...
|Currently destroyed after each request (`closeAllEditorBuffers`). link:/workspace/decisions#23[ADR-0023] proposes making these persistent across requests.
