...
// NOTE: A previous PoC file with this name (LSP wrapper around
// referenceableItemTable) has been removed. This is a different,
// future interface over the persistence layer.
