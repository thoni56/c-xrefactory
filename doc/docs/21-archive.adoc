...
deduplication is the same mechanism that hides the "what reparse cleans" gap discussed
in link:06-principles.adoc[Principles].
...
references. The dedup behaviour described above still applies — see "What Reparse
Cleans" in link:06-principles.adoc[Principles] for how it interacts with the
header-position freshness gap.
