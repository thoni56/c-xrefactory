...
The new `parsing.h` interface provides:
...
typedef struct {
    ...
    Position         cursorPosition; /* Cursor location for bounded operations */
    int              cursorOffset; /* Byte offset of cursor in file */
    int              markOffset;   /* Byte offset of mark (selection end) */
    ExtractMode      extractMode;  /* Which extraction type (function/macro/variable) */
    int              targetParameterIndex; /* Which parameter to track */
} ParsingConfig;

/* Configuration is set before parsing starts */
extern ParsingConfig parsingConfig;

/* Predicate functions document behavior */
...
parsingConfig.cursorPosition = makePositionFromMarker(target);
