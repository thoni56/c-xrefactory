...
There is many strange things going on with reading files that is not completely understood yet.
...
This could be achieved if we could remove the CharacterBuffer from
LexemBuffer and make that a reference instead of a composition.
