...
void initLexemEnumNames(void) {
    ...
    lexemEnumNames[357] = "EOI_TOKEN";
    lexemEnumNames[358] = "OL_MARKER_TOKEN";
    lexemEnumNames[359] = "OL_MARKER_TOKEN1";
    lexemEnumNames[360] = "OL_MARKER_TOKEN2";
    lexemEnumNames[361] = "TMP_TOKEN1";
    lexemEnumNames[362] = "TMP_TOKEN2";
    lexemEnumNames[363] = "MULTI_TOKENS_START";
    lexemEnumNames[364] = "IDENTIFIER";
    lexemEnumNames[365] = "CONSTANT";
    lexemEnumNames[366] = "LONG_CONSTANT";
    lexemEnumNames[367] = "FLOAT_CONSTANT";
    lexemEnumNames[368] = "DOUBLE_CONSTANT";
    lexemEnumNames[369] = "STRING_LITERAL";
    lexemEnumNames[370] = "CHAR_LITERAL";
    lexemEnumNames[371] = "LINE_TOKEN";
    lexemEnumNames[372] = "IDENT_TO_COMPLETE";
    lexemEnumNames[373] = "CPP_MACRO_ARGUMENT";
    lexemEnumNames[374] = "IDENT_NO_CPP_EXPAND";
}
