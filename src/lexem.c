...
void initLexemEnumNames(void) {
    ...
    lexemEnumNames[322] = "TOKEN";
    lexemEnumNames[323] = "TYPE";
    lexemEnumNames[324] = "LABEL";
    lexemEnumNames[325] = "COMPL_FOR_SPECIAL1";
    lexemEnumNames[326] = "COMPL_FOR_SPECIAL2";
    lexemEnumNames[327] = "COMPL_THIS_PACKAGE_SPECIAL";
    lexemEnumNames[328] = "COMPL_TYPE_NAME";
    lexemEnumNames[329] = "COMPL_STRUCT_NAME";
    lexemEnumNames[330] = "COMPL_STRUCT_REC_NAME";
    lexemEnumNames[331] = "COMPL_UP_FUN_PROFILE";
    lexemEnumNames[332] = "COMPL_ENUM_NAME";
    lexemEnumNames[333] = "COMPL_LABEL_NAME";
    lexemEnumNames[334] = "COMPL_OTHER_NAME";
    lexemEnumNames[335] = "COMPL_YACC_LEXEM_NAME";
    lexemEnumNames[336] = "CPP_TOKENS_START";
    lexemEnumNames[337] = "CPP_INCLUDE";
    lexemEnumNames[338] = "CPP_INCLUDE_NEXT";
    lexemEnumNames[339] = "CPP_DEFINE";
    lexemEnumNames[340] = "CPP_IFDEF";
    lexemEnumNames[341] = "CPP_IFNDEF";
    lexemEnumNames[342] = "CPP_IF";
    lexemEnumNames[343] = "CPP_ELSE";
    lexemEnumNames[344] = "CPP_ENDIF";
    lexemEnumNames[345] = "CPP_ELIF";
    lexemEnumNames[346] = "CPP_UNDEF";
    lexemEnumNames[347] = "CPP_PRAGMA";
    lexemEnumNames[348] = "CPP_LINE";
    lexemEnumNames[349] = "CPP_DEFINE0";
    lexemEnumNames[350] = "CPP_TOKENS_END";
    lexemEnumNames[351] = "CPP_COLLATION";
    lexemEnumNames[352] = "CPP_DEFINED_OP";
    lexemEnumNames[353] = "EOI_TOKEN";
    lexemEnumNames[354] = "CACHING1_TOKEN";
