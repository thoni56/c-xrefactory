...
CACHING1_TOKEN = 436,
OL_MARKER_TOKEN = 437,
OL_MARKER_TOKEN1 = 438,
OL_MARKER_TOKEN2 = 439,
TMP_TOKEN1 = 440,
TMP_TOKEN2 = 441,
CCC_OPER_PARENTHESIS = 442,
CCC_OPER_BRACKETS = 443,
MULTI_TOKENS_START = 444,
IDENTIFIER = 445,
CONSTANT = 446,
LONG_CONSTANT = 447,
FLOAT_CONSTANT = 448,
...
STRING_LITERAL = 450,
LINE_TOK = 451,
IDENT_TO_COMPLETE = 452,
CPP_MAC_ARG = 453,
IDENT_NO_CPP_EXPAND = 454,
CHAR_LITERAL = 455,
LAST_TOKEN = 456,
} Lexem;
