typedef struct _opaque_pthread_once_t S__opaque_pthread_once_t;
typedef struct rusage_info_v2 S_rusage_info_v2;
...
typedef struct __siginfo S___siginfo;
extern char * taskRegimesName[];
typedef struct sigaction S_sigaction;
typedef union __sigaction_u U___sigaction_u;
typedef struct ostat S_ostat;
...
typedef struct _opaque_pthread_mutexattr_t S__opaque_pthread_mutexattr_t;
typedef struct fileItemList S_fileItemList;
typedef struct symbolRefItem S_symbolRefItem;
typedef struct fssearchblock S_fssearchblock;
...
typedef struct __darwin_ucontext S___darwin_ucontext;
typedef struct _opaque_pthread_condattr_t S__opaque_pthread_condattr_t;
...
typedef struct accessx_descriptor S_accessx_descriptor;
...
typedef struct _opaque_pthread_mutex_t S__opaque_pthread_mutex_t;
...
typedef struct _opaque_pthread_rwlockattr_t S__opaque_pthread_rwlockattr_t;
typedef struct _opaque_pthread_rwlock_t S__opaque_pthread_rwlock_t;
typedef struct typeModificationsInit S_typeModificationsInit;
typedef struct olcxReferencesStack S_olcxReferencesStack;
typedef struct __darwin_pthread_handler_rec S___darwin_pthread_handler_rec;
typedef struct searchstate S_searchstate;
typedef struct editorBufferAllocationData S_editorBufferAllocationData;
typedef struct _opaque_pthread_attr_t S__opaque_pthread_attr_t;
typedef struct topBlock S_topBlock;
typedef struct __sFILEX S___sFILEX;
typedef struct timespec S_timespec;
typedef struct stat64 S_stat64;
typedef struct counters S_counters;
typedef struct symTab S_symTab;
typedef struct _telldir S__telldir;
typedef struct bb_unsigned S_bb_unsigned;
typedef struct disabledList S_disabledList;
typedef union sigval U_sigval;
...
typedef struct proc_rlimit_control_wakeupmon S_proc_rlimit_control_wakeupmon;
typedef struct __sFILE S___sFILE;
extern char * editorsName[];
typedef struct fd_set S_fd_set;
...
typedef struct sigvec S_sigvec;
...
typedef struct _opaque_pthread_cond_t S__opaque_pthread_cond_t;
typedef struct cxScanFileFunctionLink S_cxScanFileFunctionLink;
typedef struct macroBody S_macroBody;
typedef struct __darwin_sigaltstack S___darwin_sigaltstack;
typedef struct rusage_info_v3 S_rusage_info_v3;
typedef struct jslTypeTab S_jslTypeTab;
typedef struct tpCheckSpecialReferencesData S_tpCheckSpecialReferencesData;
typedef struct sigstack S_sigstack;
extern char * refsFilterLevelsName[];
typedef struct _opaque_pthread_t S__opaque_pthread_t;
...
typedef struct rusage_info_v0 S_rusage_info_v0;
