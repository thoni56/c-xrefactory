...
/*
  Here we define the things that are needed and which are defined by the compiler as builtins.
  Examples are pre-defined include paths, various macros, some of which are kind of typedef's.

  NOTE1: that they need not translate to something real, just something that parses right.

  NOTE2: there is also an attempt at figuring out pre-defined include paths in
         main.c:getAndProcessGccOptions()
...
static char *s_standardCOptions[] = {
    ...
    */
    ...
    "-D__WCHAR_TYPE__=int",
    "-D__WINT_TYPE__=int",
    "-D__INTMAX_TYPE__=int",
    "-D__UINTMAX_TYPE__=int",
    ...
    "-D__INT64_TYPE__=int",
    "-D__UINT8_TYPE__=int",
    "-D__UINT16_TYPE__=int",
    "-D__UINT32_TYPE__=int",
    "-D__UINT64_TYPE__=int",
    "-D__INT_LEAST8_TYPE__=int",
    "-D__INT_LEAST16_TYPE__=int",
    "-D__INT_LEAST32_TYPE__=int",
    "-D__INT_LEAST64_TYPE__=int",
    "-D__UINT_LEAST8_TYPE__=int",
    "-D__UINT_LEAST16_TYPE__=int",
    "-D__UINT_LEAST32_TYPE__=int",
    "-D__UINT_LEAST64_TYPE__=int",
    "-D__INT_FAST8_TYPE__=int",
    "-D__INT_FAST16_TYPE__=int",
    "-D__INT_FAST32_TYPE__=int",
    "-D__INT_FAST64_TYPE__=int",
    "-D__UINT_FAST8_TYPE__=int",
    "-D__UINT_FAST16_TYPE__=int",
    "-D__UINT_FAST32_TYPE__=int",
    "-D__UINT_FAST64_TYPE__=int",
    "-D__INTPTR_TYPE__=int",
    "-D__UINTPTR_TYPE__=int",
    "-D__attribute__(xxx) ",
    "-D__alignof__(xxx) 8",
    "-Dtypeof(xxx) int",
    "-D__typeof__(xxx) int",
