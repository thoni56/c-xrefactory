...
extern cJSON *add_action(cJSON *target, const char *name, const char *kind);
extern cJSON *add_item(cJSON *target, const char *name);
extern cJSON *add_object_to_array(cJSON *target);
