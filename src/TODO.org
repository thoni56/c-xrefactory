...
** TRIED Move editServerSinglePass() to server.c
*** REQUIRES fileProcessingInitialisations()
*** REQUIRES smartReadReferences()
*** REQUIRES symbolCanBeIdentifiedByPosition()
*** REQUIRES closeInputFile()
*** REQUIRES editServerParseInputFile()
*** REQUIRES gotOnLineCxRefs()
*** REQUIRES addThisFileDefineIncludeReference()
*** REQUIRES scheduleFileUsingTheMacro()
