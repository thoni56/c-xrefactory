...
* DOING Tool to convert debug log from Emacs/c-xref into commands for edit-server-driver.py
* DOING Create testcases for all jexercise and cexercise steps
** DOING cexercise
*** DONE F6 to completion() and completions
*** TODO <next step>
** TODO jexercise - Only Java 8 since we can't parse JDK for > 8
*** TODO F6 to completion() and completions
*** TODO <next step>
* DOING Move XX_ALLOCC and friends to "memory" module
* TODO Create jar reading test for unexpected end of file
* TODO Split out more specific tests from ?exercise tests, like "rename_with_conflicts"
...
* TODO Remove zlib from repo, point to it's repo instead
* TODO New features
** TODO New refactoring: move function
