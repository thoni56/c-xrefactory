...
* DOING BUG: an unterminated "assert(" (with the c-xref def of it: MACRO) breaks
Test case end_of_macro exhibits this.
NOTE: An uncompleted macro outside any context segv:s
