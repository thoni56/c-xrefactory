...
* DOING Read java runtime which now has many more options
** DONE Understand why reading jar takes up all memory
** DONE Support new class file constant pool items for v52.0
** TODO Crash when swapping CXrefs after reading jdk1.8.0_121_jre_lib_rt.jar
...
* TODO Introduce data driven strategy to find runtime
jrt-fs.jar, ...
