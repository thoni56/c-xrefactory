...
Current Mikado:
* TRYING Break out xref from main.c
** DONE Move xref() to new file xref.c
** DONE Move mainCallXref() to xref.c
*** DONE scheduleModifiedFilesToUpdate(void) etc.
** DONE Move scheduleModifiedFilesToUpdate() to xref.c
