...
** TODO Add as reference to the field
* TODO enum-generation does not do automatical compiler defines discovery?
* TODO Add a test for reading class files (note only 1.4 max for now...)
...
* TODO Rather than "fprintf(dumpOut..." use log()
