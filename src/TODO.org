...
* TODO Rename C module
** TODO Rename included file
*** TODO New refactoring: Rename Included File
*** TODO Rename the file
*** TODO Update all #includes
*** TODO Prohibit rename of files included with '<>'
** TODO Rename corresponding .h file if exists
** TODO Update all #includes
* DOING LSP-mode support
** DOING 'didOpen'
