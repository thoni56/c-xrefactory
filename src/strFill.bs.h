...
#define FILL_symStructSpec(STRUCTP, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8) {\
	(STRUCTP)->super = ARG0;\
	...
	(STRUCTP)->classFile = ARG7;\
	(STRUCTP)->recSearchCounter = ARG8;\
}
#define FILLF_symStructSpec(STRUCTP, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, ARG11, ARG12, ARG13, ARG14, ARG15, ARG16, ARG17) {\
	(STRUCTP)->super = ARG0;\
	(STRUCTP)->records = ARG1;\
	...
	(STRUCTP)->classFile = ARG16;\
	(STRUCTP)->recSearchCounter = ARG17;\
}
#define _FILLF_symStructSpec(STRUCTP, ARGS) {\
	(STRUCTP)->super = _ARG_0_OF_18 ARGS;\
	(STRUCTP)->records = _ARG_1_OF_18 ARGS;\
	(STRUCTP)->casts.node = _ARG_2_OF_18 ARGS;\
	(STRUCTP)->casts.sub = _ARG_3_OF_18 ARGS;\
	(STRUCTP)->nestedCount = _ARG_4_OF_18 ARGS;\
	(STRUCTP)->nest = _ARG_5_OF_18 ARGS;\
	(STRUCTP)->stype.kind = _ARG_6_OF_18 ARGS;\
	_FILLUREC_typeModifierUnion_##_ARG_7_OF_18 ARGS((&(STRUCTP)->stype.u), _ARG_8_OF_18 ARGS);\
	(STRUCTP)->stype.typedefSymbol = _ARG_9_OF_18 ARGS;\
	(STRUCTP)->stype.next = _ARG_10_OF_18 ARGS;\
	(STRUCTP)->sptrtype.kind = _ARG_11_OF_18 ARGS;\
	_FILLUREC_typeModifierUnion_##_ARG_12_OF_18 ARGS((&(STRUCTP)->sptrtype.u), _ARG_13_OF_18 ARGS);\
	(STRUCTP)->sptrtype.typedefSymbol = _ARG_14_OF_18 ARGS;\
	(STRUCTP)->sptrtype.next = _ARG_15_OF_18 ARGS;\
	(STRUCTP)->classFile = _ARG_16_OF_18 ARGS;\
	(STRUCTP)->recSearchCounter = _ARG_17_OF_18 ARGS;\
}
...
#define FILL_macroBody(STRUCTP) {\
}
#define FILLF_macroBody(STRUCTP) {\
}
...
#define _FILLF_options(STRUCTP, ARGS) {\
	...
	(STRUCTP)->cxMemoryFactor = _ARG_90_OF_153 ARGS;\
