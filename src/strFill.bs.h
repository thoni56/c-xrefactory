...
#define FILLF_symbol(STRUCTP, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, ARG11, ARG12, ARG13, ARG14, ARG15) {\
	...
	(STRUCTP)->pos.col = ARG4;\
	(STRUCTP)->bits.record = ARG5;\
	(STRUCTP)->bits.isSingleImported = ARG6;\
	(STRUCTP)->bits.accessFlags = ARG7;\
	(STRUCTP)->bits.javaSourceLoaded = ARG8;\
	(STRUCTP)->bits.javaFileLoaded = ARG9;\
	(STRUCTP)->bits.symType = ARG10;\
	(STRUCTP)->bits.storage = ARG11;\
	(STRUCTP)->bits.npointers = ARG12;\
...
#define _FILLF_symbol(STRUCTP, ARGS) {\
	...
	(STRUCTP)->pos.col = _ARG_4_OF_16 ARGS;\
	(STRUCTP)->bits.record = _ARG_5_OF_16 ARGS;\
	(STRUCTP)->bits.isSingleImported = _ARG_6_OF_16 ARGS;\
	(STRUCTP)->bits.accessFlags = _ARG_7_OF_16 ARGS;\
	(STRUCTP)->bits.javaSourceLoaded = _ARG_8_OF_16 ARGS;\
	(STRUCTP)->bits.javaFileLoaded = _ARG_9_OF_16 ARGS;\
	(STRUCTP)->bits.symType = _ARG_10_OF_16 ARGS;\
	(STRUCTP)->bits.storage = _ARG_11_OF_16 ARGS;\
	(STRUCTP)->bits.npointers = _ARG_12_OF_16 ARGS;\
...
#define FILL_symTab(STRUCTP) {\
}
#define FILLF_symTab(STRUCTP) {\
}
...
#define _FILLF_fileItem(STRUCTP, ARGS) {\
	...
	(STRUCTP)->lastModified = _ARG_1_OF_19 ARGS;\
	(STRUCTP)->lastInspected = _ARG_2_OF_19 ARGS;\
...
#define _FILLF_bb_position(STRUCTP, ARGS) {\
	...
	(STRUCTP)->d.col = _ARG_8_OF_9 ARGS;\
}
...
#define FILL_jslTypeTab(STRUCTP) {\
}
#define FILLF_jslTypeTab(STRUCTP) {\
}
...
#define _FILLF_idIdentList(STRUCTP, ARGS) {\
	...
	(STRUCTP)->idi.p.col = _ARG_4_OF_9 ARGS;\
