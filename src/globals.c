...
S_tokenNameIni s_tokenNameIniTab[] = {
    {"asm",         ASM_KEYWORD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"auto",        AUTO            ,LANG_C | LANG_YACC | LANG_CCC},
    {"enum",        ENUM            ,LANG_C | LANG_YACC | LANG_CCC},
    {"extern",      EXTERN          ,LANG_C | LANG_YACC | LANG_CCC},
    {"inline",      INLINE          ,LANG_C | LANG_YACC | LANG_CCC},
    {"register",    REGISTER        ,LANG_C | LANG_YACC | LANG_CCC},
    {"signed",      SIGNED          ,LANG_C | LANG_YACC | LANG_CCC},
    {"sizeof",      SIZEOF          ,LANG_C | LANG_YACC | LANG_CCC},
    {"struct",      STRUCT          ,LANG_C | LANG_YACC | LANG_CCC},
    {"typedef",     TYPEDEF         ,LANG_C | LANG_YACC | LANG_CCC},
    {"union",       UNION           ,LANG_C | LANG_YACC | LANG_CCC},
    {"unsigned",    UNSIGNED        ,LANG_C | LANG_YACC | LANG_CCC},
    ...
    {"break",       BREAK           ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"case",        CASE            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"char",        CHAR            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"const",       CONST           ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"continue",    CONTINUE        ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"default",     DEFAULT         ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"do",          DO              ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"double",      DOUBLE          ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"else",        ELSE            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"float",       FLOAT           ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"for",         FOR             ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"goto",        GOTO            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"if",          IF              ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"int",         INT             ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"long",        LONG            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"return",      RETURN          ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"short",       SHORT           ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"static",      STATIC          ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"switch",      SWITCH          ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"void",        VOID            ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"volatile",    VOLATILE        ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
    {"while",       WHILE           ,LANG_C | LANG_YACC | LANG_CCC | LANG_JAVA},
...
S_tokenNameIni s_tokenNameIniTab2[] = {
    {"__const",         CONST           ,LANG_C | LANG_YACC | LANG_CCC},
    {"__const__",       CONST           ,LANG_C | LANG_YACC | LANG_CCC},
    {"__signed",        SIGNED          ,LANG_C | LANG_YACC | LANG_CCC},
    {"__signed__",      SIGNED          ,LANG_C | LANG_YACC | LANG_CCC},
    {"__inline",        ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__inline__",      ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__volatile",      VOLATILE        ,LANG_C | LANG_YACC | LANG_CCC},
    {"__volatile__",    VOLATILE        ,LANG_C | LANG_YACC | LANG_CCC},
    {"__asm",           ASM_KEYWORD     ,LANG_C | LANG_CCC},
    {"__asm__",         ASM_KEYWORD     ,LANG_C | LANG_CCC},
    {"__label__",       LABEL           ,LANG_C | LANG_CCC},
    {"__near",          ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__far",           ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__pascal",        ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"_near",           ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"_far",            ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"_pascal",         ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"_const",          ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__near",          ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__far",           ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__pascal",        ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__cdecl",         ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__fastcall",      ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__stdcall",       ANONYME_MOD     ,LANG_C | LANG_YACC | LANG_CCC},
    {"__int8",          INT             ,LANG_C | LANG_YACC | LANG_CCC},
    {"__int16",         INT             ,LANG_C | LANG_YACC | LANG_CCC},
    {"__int32",         INT             ,LANG_C | LANG_YACC | LANG_CCC},
    {"__int64",         INT             ,LANG_C | LANG_YACC | LANG_CCC},
    {NULL,      0       ,LANG_C}         /* sentinel*/
};
