...
/*
  Follow the instructions in the comments to try the C-Xrefactory
  source browser.
*/
...
class Browsing {
	...
	// using F3 and F4 inspect all its references.  Finally pop
	...
	*/
	...
	/*
	  ...
	  class tree.  It shows also many usages of the method in your
	  project are syntacticaly related to those classes.

	  In left window:
	    <space>         - select one class only and move to the definition
	    <Ins>           - toggle select/unselect
	    mouse-button12  - select one class only and move to the definition
